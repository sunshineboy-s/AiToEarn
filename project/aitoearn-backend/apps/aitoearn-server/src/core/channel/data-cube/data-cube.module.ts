...
@Module({
  imports: [ChannelSharedModule, BilibiliModule, MetaModule, YoutubeModule, WxPlatModule, PinterestModule, XianyuModule],
  controllers: [DataCubeController],
  providers: [BilibiliDataService, FacebookDataService, InstagramDataService, ThreadsDataService, YoutubeDataService, WxGzhDataService, PinterestDataService, XianyuDataService],
  exports: [BilibiliDataService, FacebookDataService, InstagramDataService, ThreadsDataService, YoutubeDataService, WxGzhDataService, PinterestDataService, XianyuDataService],
})
